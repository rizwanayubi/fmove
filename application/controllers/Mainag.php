...
class Mainag extends CI_Controller{
    ...
    function agentprof()
    {
        ...
        $curr_login = $this->session->userData('userData');
            ...
            $my_props = $this->Property_model->get_prop_where('agent_id', $curr_login['agentData']['UserData']['id']);
            $my_inqs = $this->Agent_model->getinquiries($curr_login['agentData']['UserData']['id']);
            $my_inbox = $this->Agent_model->showainbox($curr_login['agentData']['UserData']['id']);
       ...
       $this->db->select_max('prop_id');
        ...
        {   
            ...
            $params = array(
                ...
                'agent_id' => $agent['agentData']['UserData']['id'],
