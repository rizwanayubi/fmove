          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="AC" value="<?php echo $this->input->post('AC'); ?>" class="form-control" id="AC" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="Barbeque" class="control-label">Barbeque</label>
						<div class="form-group">
							<input type="text" name="Barbeque" value="<?php echo $this->input->post('Barbeque'); ?>" class="form-control" id="Barbeque" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="Dryer" class="control-label">Dryer</label>
						<div class="form-group">
							<input type="text" name="Dryer" value="<?php echo $this->input->post('Dryer'); ?>" class="form-control" id="Dryer" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="Laundry" class="control-label">Laundry</label>
						<div class="form-group">
							<input type="text" name="Laundry" value="<?php echo $this->input->post('Laundry'); ?>" class="form-control" id="Laundry" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="Microwave" class="control-label">Microwave</label>
						<div class="form-group">
							<input type="text" name="Microwave" value="<?php echo $this->input->post('Microwave'); ?>" class="form-control" id="Microwave" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="Lawn" class="control-label">Lawn</label>
						<div class="form-group">
							<input type="text" name="Lawn" value="<?php echo $this->input->post('Lawn'); ?>" class="form-control" id="Lawn" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="Shower" class="control-label">Shower</label>
						<div class="form-group">
							<input type="text" name="Shower" value="<?php echo $this->input->post('Shower'); ?>" class="form-control" id="Shower" />
						</div>
					</div>
				</div>
			</div>
