          ...
          <div class="tab-content padding_half">
            <div role="tabpanel" class="tab-pane fade in active" id="home">
              <div class="agent-p-form">
                <form action="admin_login" method="post" class="callus clearfix">
                  <div class="single-query form-group col-sm-12">
                    <input type="text" name="username" class="keyword-input" placeholder="username">
                  </div>
                  <div class="single-query form-group  col-sm-12">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="col-sm-6 text-right">
                        <a href="adreset" class="lost-pass">Lost your password?</a>
                      </div>
                    </div>
                  </div>
                  <div class=" col-sm-12">
