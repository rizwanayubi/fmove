    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Prop Po Edit</h3>
            </div>
			<?php echo form_open('prop_position/edit/'.$prop_po['id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="prop_id" class="form-control">
								...
								{
									$selected = ($property['prop_id'] == $prop_po['prop_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="position" class="form-control">
								...
								{
									$selected = ($value == $prop_po['position']) ? ' selected="selected"' : "";
